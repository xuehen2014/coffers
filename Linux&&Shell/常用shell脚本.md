...
do
  ...
  sleep 5s
  su - sync360 -c "source /home/q/system/micros/finance-job/BiJobs/bin/env.sh;/home/q/system/micros/finance-job/BiJobs/bin/biJobs dataGenerateTask adUserIdMapCustomerIdAgencyId --inputDate=${date_str}"
  echo `date "+%Y-%m-%d %H:%M:%S"`
